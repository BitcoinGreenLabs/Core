...
const char * const BITCOIN_CONF_FILENAME = "bitcoingreen.conf";
const char * const BITCOIN_PID_FILENAME = "bitcoingreend.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitcoinGreen";
#else
    // Unix
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    std::string strCopyrightHolders =
        ...
        "\n" + strPrefix + "BitcoinGreen developers";
