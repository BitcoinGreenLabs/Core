...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BitcoinGreenLabs/Core>";
    const std::string URL_WEBSITE = "<https://btcgreen.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The BitcoinGreen Developers", 2022)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find BitcoinGreen useful. "
