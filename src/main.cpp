...
#if defined(NDEBUG)
# error "BitcoinGreen cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BitcoinGreen Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // BitcoinGreen also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // BitcoinGreen also requires low S in sigs
