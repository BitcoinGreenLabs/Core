...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"bitcoingreenaddress\"\n"
            "\nReveals the private key corresponding to 'bitcoingreenaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"bitcoingreenaddress\"   (string, required) The bitcoingreen address for the private key\n"
            "\nResult:\n"
