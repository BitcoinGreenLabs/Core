...
These are the dependencies currently used by BitcoinGreen. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/bitcoingreennl
Keybase  - https://keybase.io/team/bitcoingreen/
