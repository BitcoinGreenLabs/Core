UNIX BUILD NOTES
====================
Some notes on how to build BitcoinGreen in Unix.
...
memory available when compiling BitcoinGreen. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build BitcoinGreen without wallet.
...
# Configure BitcoinGreen to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
Security
--------
To help make your bitcoingreen installation more secure by making certain attacks impossible to
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, bitcoingreen may be compiled in
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://gitlab.com/bitcoingreen/bitcoingreen.git
    cd bitcoingreen/
    ./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard BitcoinGreen distributions and independently built
